...
# Prompt Template
# ==============================
PROMPT_TEMPLATE = """You are an AI assistant for Business Gateways International (BGI).
...
if __name__ == "__main__":
    sample_chunks = [
        {"source": "bgi_overview.pdf", "text": "BGI was founded to provide business consulting services."},
        {"source": "bgi_overview.pdf", "text": "The company is headquartered in Chennai, India."}
    ]
